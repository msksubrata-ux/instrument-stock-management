...
# =========================================================
    ...
    # Admin always has Edit/Delete permission.
    # Normal user needs can_stock_in_edit_delete = 1.
    permission_check = (
        supabase
        .table("users")
